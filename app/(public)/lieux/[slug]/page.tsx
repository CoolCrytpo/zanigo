        ...
        >
          {listing.cover_url ? (
            ...
            <div className="w-full h-full flex items-center justify-center">
              <svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="rgba(255,255,255,0.3)" strokeWidth="1.25" strokeLinecap="round" strokeLinejoin="round"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg>
            </div>
          )}
          <div
                ...
                <div className="flex flex-col gap-2 text-sm">
                  ...
                  {listing.contact_phone && (
                    <div className="flex gap-2 items-center">
                      ...
                      <a href={`tel:${listing.contact_phone}`} style={{ color: 'var(--color-green)' }}>
                  ...
                  {listing.website_url && (
                    <div className="flex gap-2 items-center">
                      ...
                      <a href={listing.website_url} target="_blank" rel="noopener noreferrer" className="truncate" style={{ color: 'var(--color-blue)' }}>
                        Site web
                      </a>
                    </div>
                  )}
